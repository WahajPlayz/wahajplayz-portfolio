...
export interface StoreProduct {
  ...
  colorOptions?: { id: string; label: string; hex: string; imageUrl?: string }[];
  typeOptions?: string[];
  sizeOptions?: string[];
...
export interface StoreConfig {
  ...
  heading: string;
  subheading: string;
  storePage: { headline: string; subheading: string };
  categories: string[];
...
export const storeDefaults: StoreConfig = {
  enabled: true,
  heading: 'Shop',
  subheading: 'Grab something cool — digital downloads & merch.',
  storePage: {
    headline: 'The Shop',
    subheading: 'Support the project and take something home.',
  },
  categories: ['Game Assets', 'Merch', 'Art', 'Source Code'],
  products: [],
};
