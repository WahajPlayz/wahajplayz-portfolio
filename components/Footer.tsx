...
const socialLinks = [
  ...
  { href: 'https://ko-fi.com/wahajplayz', label: 'Ko-fi', icon: <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M23.881 8.948c-.773-4.085-4.859-4.593-4.859-4.593H.723c-.604 0-.679.798-.679.798s-.082 7.324-.022 11.822c.164 2.424 2.586 2.672 2.586 2.672s8.267-.023 11.966-.049c2.438-.426 2.683-2.566 2.658-3.734 4.352.24 7.422-2.831 6.649-6.916z"/></svg>, hoverBg: 'rgba(168,85,247,0.15)', hoverBorder: 'rgba(168,85,247,0.4)' },
];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-12">
            <a href="https://ko-fi.com/wahajplayz" target="_blank" rel="noopener noreferrer"
